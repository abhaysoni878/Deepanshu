...
class MathDemo
{
    public static void main(String args[])
    {
		...
		System.out.println("All ceiling values are as follows");
	    ...
	    System.out.println("The Maximum values is "+maxVal);
		...
		System.out.println("The sqare root of 5 is "+Math.sqrt(5));
    }
}
